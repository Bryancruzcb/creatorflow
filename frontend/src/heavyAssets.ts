...
export const heavyAssets: HeavyAssetRecord[] = [
  {
    ...
    modelUrl: assetUrl('/assets/robot-expressive.glb'),
    previewUrl: assetUrl('/assets/robot-expressive-preview.svg'),
    sourceUrl: 'https://github.com/mrdoob/three.js/tree/dev/examples/models/gltf/RobotExpressive',
    licenseUrl: assetUrl('/assets/robot-expressive-license.txt'),
  ...
  },
  {
    ...
    modelUrl: assetUrl('/assets/fox-animated.glb'),
    ...
    licenseUrl: assetUrl('/assets/FOX-LICENSE.md'),
  ...
  },
  {
    ...
    modelUrl: assetUrl('/assets/morph-stress-test.glb'),
    ...
    licenseUrl: assetUrl('/assets/MORPH-STRESS-TEST-LICENSE.md'),
    license: 'CC BY 4.0',
  ...
  },
  {
    ...
    modelUrl: assetUrl('/assets/dutch-ship-large-01.glb'),
    previewUrl: assetUrl('/assets/dutch-ship-large-01.png'),
  ...
  },
  {
    ...
    modelUrl: assetUrl('/assets/dutch-ship-large-02.glb'),
    previewUrl: assetUrl('/assets/dutch-ship-large-02.png'),
  ...
  },
  {
    ...
    modelUrl: assetUrl('/assets/beautiful-game.glb'),
    previewUrl: assetUrl('/assets/beautiful-game.jpg'),
  ...
  },
  {
    ...
    modelUrl: assetUrl('/assets/mosquito-in-amber.glb'),
    previewUrl: assetUrl('/assets/mosquito-in-amber.jpg'),
  ...
  },
  {
    ...
    modelUrl: assetUrl('/assets/node-performance-test.glb'),
    previewUrl: assetUrl('/assets/node-performance-test.jpg'),
  ...
  },
  {
    ...
    modelUrl: assetUrl('/assets/corset.glb'),
    previewUrl: assetUrl('/assets/corset.jpg'),
