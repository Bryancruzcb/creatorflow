...
export const robloxProjectNodes: RobloxProjectNode[] = [
  ...
  { id: 'harbor', parentId: 'workspace', name: 'HarborExhibit', path: 'Workspace.HarborExhibit', className: 'Model', kind: 'model', evidenceState: 'clear', changeState: 'unchanged', previewUrl: assetUrl('/assets/dutch-ship-large-01.png'), note: 'Two maritime hero models with reusable, attributed material families.' },
  { id: 'ship-a', parentId: 'harbor', name: 'DutchShipA', path: 'Workspace.HarborExhibit.DutchShipA', className: 'Model', kind: 'model', evidenceState: 'clear', changeState: 'unchanged', previewUrl: assetUrl('/assets/dutch-ship-large-01.png'), license: 'CC0 1.0 Universal', sourceStatus: 'recorded' },
  { id: 'ship-b', parentId: 'harbor', name: 'DutchShipB', path: 'Workspace.HarborExhibit.DutchShipB', className: 'Model', kind: 'model', evidenceState: 'clear', changeState: 'unchanged', previewUrl: assetUrl('/assets/dutch-ship-large-02.png'), license: 'CC0 1.0 Universal', sourceStatus: 'recorded' },
  ...
  { id: 'chess-hall', parentId: 'gallery', name: 'ChessHall', path: 'Workspace.GrandGallery.ChessHall', className: 'Model', kind: 'model', evidenceState: 'clear', changeState: 'unchanged', previewUrl: assetUrl('/assets/beautiful-game.jpg'), license: 'CC BY 4.0', sourceStatus: 'recorded', note: 'Repeated chess pieces are legitimate in-file instances, not duplicate-source findings.' },
  { id: 'amber-case', parentId: 'gallery', name: 'AmberCase', path: 'Workspace.GrandGallery.AmberCase', className: 'Model', kind: 'model', evidenceState: 'clear', changeState: 'unchanged', previewUrl: assetUrl('/assets/mosquito-in-amber.jpg'), license: 'CC BY 4.0', sourceStatus: 'recorded' },
  { id: 'wardrobe', parentId: 'gallery', name: 'WardrobeStudy', path: 'Workspace.GrandGallery.WardrobeStudy', className: 'Model', kind: 'model', evidenceState: 'clear', changeState: 'unchanged', previewUrl: assetUrl('/assets/corset.jpg'), license: 'CC BY 4.0', sourceStatus: 'recorded' },
