          ...
          <div className="heavy-asset-detail">
            ...
            {selectedComponent ? (
              <div className={`difference-modebar ${comparisonActive ? 'difference-modebar--comparison' : ''}`}>
                ...
                <small>{comparisonActive ? comparisonMode === 'overlay' ? 'Blue project · amber source' : comparisonMode === 'blink' ? 'Motion-safe fallback included' : comparisonMode === 'heatmap' ? 'Dark near · bright far · grey unmeasured' : 'Equal normalized frames' : 'Selected part remains clickable'}</small>
              </div>
            ) : null}
